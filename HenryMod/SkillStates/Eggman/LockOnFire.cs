...
namespace HenryMod.SkillStates
{
	...
	public class LockOnFire : GenericBulletBaseState
	{
		// Token: 0x06001331 RID: 4913 RVA: 0x000556F8 File Offset: 0x000538F8
		public override void OnEnter()
		{
			this.fireSoundString = ((base.characterBody.spreadBloomAngle <= LockOnFire.tightSoundSwitchThreshold) ? LockOnFire.tightSoundString : LockOnFire.wideSoundString);
			base.OnEnter();
			this.PlayAnimation("Gesture, Additive", "LockOnFire");
			this.PlayAnimation("Gesture, Override", "LockOnFire");
		}
