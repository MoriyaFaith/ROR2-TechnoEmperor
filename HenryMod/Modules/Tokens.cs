...
namespace TechnoEmperorMod.Modules
{
    internal static class Tokens
    {
        internal static void AddTokens()
        {
            ...
            LanguageAPI.Add(prefix + "NAME", "Conquerer");
            ...
            LanguageAPI.Add(prefix + "UTILITY_ROLL_DESCRIPTION", $"Create a forcefield around you that absorbs projectiles and <style=cIsUtility>heals 60% of the damage absorbed</style>. <style=cIsDamage>Does not absorb melee attacks.</style>");
            #endregion
