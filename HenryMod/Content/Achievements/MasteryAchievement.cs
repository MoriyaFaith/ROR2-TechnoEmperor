...
namespace HenryMod.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => HenryPlugin.DEVELOPER_PREFIX + "_TECHNO_EMPEROR_BODY_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => HenryPlugin.DEVELOPER_PREFIX + "_TECHNO_EMPEROR_BODY_UNLOCKABLE_REWARD_ID";
